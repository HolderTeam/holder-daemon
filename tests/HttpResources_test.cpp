...
TEST_CASE("HTTP resources create/list/delete", "[http]") {
  ...
  nlohmann::json patch_body = {{"label", "Updated"}, {"desc", nullptr}, {"updated_at", 20}};
  ...
  const auto listed_after_patch = http_json_request(
      bound.bind,
      bound.port,
      token,
      boost::beast::http::verb::get,
...
TEST_CASE("HTTP resources validation and route variants", "[http]") {
  ...
  const auto missing_updated_at = http_json_request(
      bound.bind,
      bound.port,
      token,
      boost::beast::http::verb::patch,
  ...
  const auto not_found_patch = http_json_request(
      bound.bind,
      bound.port,
      token,
      boost::beast::http::verb::patch,
  ...
  const auto patch_ok = http_json_request(
      bound.bind,
      bound.port,
      token,
      boost::beast::http::verb::patch,
  ...
  const auto route_not_found = http_json_request(
      bound.bind,
      bound.port,
      token,
      boost::beast::http::verb::patch,
  ...
  const auto bad_method = http_json_request(
      bound.bind,
      bound.port,
      token,
      boost::beast::http::verb::get,
...
TEST_CASE("HTTP resources catch branches on repository failures", "[http]") {
  ...
  const auto get_fail = http_json_request(
      bound.bind,
      bound.port,
      token,
      boost::beast::http::verb::get,
  ...
  const auto patch_fail = http_json_request(
      bound.bind,
      bound.port,
      token,
      boost::beast::http::verb::patch,
  ...
  const auto delete_fail = http_json_request(
      bound.bind,
      bound.port,
      token,
      boost::beast::http::verb::delete_,
