...
TEST_CASE("HTTP project recovery token export/import round-trip", "[http]") {
  ...
  const auto exported = http_json_request(bound.bind,
                                          bound.port,
                                          token,
                                          boost::beast::http::verb::post,
  ...
  const auto fetched_cleared = http_json_request(bound.bind,
                                                 bound.port,
                                                 token,
                                                 boost::beast::http::verb::get,
                                                 "/projects/proj-1",
  ...
  const auto bad_import = http_json_request(bound.bind,
                                            bound.port,
                                            token,
                                            boost::beast::http::verb::post,
  ...
  const auto imported = http_json_request(bound.bind,
                                          bound.port,
                                          token,
                                          boost::beast::http::verb::post,
                                          "/projects/proj-1/recovery-token/import",
  ...
  const auto fetched_after_import = http_json_request(bound.bind,
                                                      bound.port,
                                                      token,
                                                      boost::beast::http::verb::get,
                                                      "/projects/proj-1",
...
TEST_CASE("HTTP recovery token import rejects project mismatch", "[http]") {
  ...
  const auto mismatch = http_json_request(bound.bind,
                                          bound.port,
                                          token,
                                          boost::beast::http::verb::post,
