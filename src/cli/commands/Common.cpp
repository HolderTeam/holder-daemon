...
void print_usage(std::ostream& out) {
  out << "Usage: holderctl <command>\n"
      ...
      << "  sync       Inspect Git sync status, configure/test the remote, and push commits\n"
      ...
      << "  link       Link one card to another in the current project\n"
      << "  trash      Trash cards and manage trashed cards\n"
      << "  restore    Restore a trashed card in the current project\n"
