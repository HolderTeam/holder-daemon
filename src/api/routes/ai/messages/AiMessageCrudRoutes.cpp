...
nlohmann::json ai_message_to_json(const holder::model::AiMessage& msg) {
  ...
  data["deleted_at"] = msg.deleted_at.has_value() ? nlohmann::json(msg.deleted_at.value())
                                                  : nlohmann::json(nullptr);
...
bool handle_ai_message_crud_routes(
